...
if (ipi_available && exists("ipi_passthrough_jun") && exists("ipi_passthrough")) {
  ...
  tryCatch({
    header_row <- c("", "Inputs", "", "", "Price Changes", "", "", "Implied Passthrough", "", "")
    col_names <- c("Category", "Import share", "Tariff increase", "Expected effect",
                   "2025 Change", "vs LP Trend", "vs Log-Linear",
                   "2025 Change", "vs LP Trend", "vs Log-Linear")
    lines <- character()
    lines <- c(lines, paste(shQuote(header_row, type = "cmd"), collapse = ","))
    ...
    meta_lines <- c(
      "",
      paste0("# ", strip_commas(paste0(fig_meta("T1a", "label"), ". ", fig_meta("T1a", "title")))),
      paste0("# Source: ", strip_commas(fig_meta("T1a", "source")))
    )
    cat(paste0(meta_lines, collapse = "\n"), "\n", file = t1_path, append = TRUE)
...
# TA: Combined All-PCE Passthrough (June 2025 + latest month)
{
  ...
  tryCatch({
    ...
    meta_lines <- c(
      "",
      paste0("# ", strip_commas(paste0(fig_meta("TA1", "label"), ". ", fig_meta("TA1", "title")))),
      paste0("# Source: ", strip_commas(fig_meta("TA1", "source")))
    )
    cat(paste0(meta_lines, collapse = "\n"), "\n", file = ta_path, append = TRUE)
