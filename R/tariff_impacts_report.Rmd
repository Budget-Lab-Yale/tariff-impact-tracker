...
- **Tariff revenue:** The 2025 tariffs have raised an estimated $`r safe_fmt(total_excess_rev)` billion in inflation-adjusted customs revenue above the 2022--2024 average as of `r latest_month_name`1, with the effective tariff rate reaching `r safe_fmt(latest_tariff_rate)`% in `r latest_tariff_month`.
...
So far, there is no definitive indication of any effect of tariffs on the aggregate job market. Total nonfarm employment as of `r unemp_latest_date` changed by `r safe_fmt(nonfarm_yoy_change / 1000, "%+.1f")`M jobs relative to the level of employment one year earlier. This is lower than that same statistic from one year prior (`r safe_fmt(nonfarm_yoy_change_prior / 1000, "%+.1f")`M).
